...
const events = [
    ...
    },
    {
        ...
        price: 120,
        category: "sports",
        image: "https://images.unsplash.com/photo-1560272564-c83b66b1ad12?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1474&q=80",
    ...
    },
    {
        ...
        price: 90,
        category: "sports",
        image: "https://images.unsplash.com/photo-1571008887538-b36bb32f4571?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
        seats: generateSeats(1000)
    },
    {
        id: 9,
...
heroSignupBtn.addEventListener('click', (e) => {
    ...
    if (!currentUser) {
        ...
        // Mostrar seção de criação de eventos
